    ...
    TR_OpaqueClassBlock *declaringClass)
{
    ...
    static bool disableITableIterationsAfterLastITableCacheCheck
        = feGetEnv("TR_DisableITableIterationsAfterLastITableCacheCheck") != NULL;
...
TR::Instruction *generateLastITableAndITableInstructions(TR::CodeGenerator *cg, TR::Node *callNode,
    ...
    TR::Register *loopCountRegister, TR::RegisterDependencyConditions *postDeps, TR::Instruction *cursor)
{
    ...
    if (!cg->profiledPointersRequireRelocation() && !comp->getOption(TR_DisableLastITableCache)
        ...
        // Jump OOL.
        cursor = generateS390BranchInstruction(cg, TR::InstOpCode::BRC, TR::InstOpCode::COND_B, callNode, entryLabel,
            cursor);
