...
int32_t *TR_Debug::printStackAtlas(uintptr_t startPC, uint8_t *mapBits, int32_t numberOfSlotsMapped,
    bool fourByteOffsets, int32_t *sizeOfStackAtlas, int32_t frameSize)
{
    ...
    uint16_t indexOfFirstInternalPtr = printStackAtlasDetails(startPC, mapBits, numberOfSlotsMapped, fourByteOffsets,
        sizeOfStackAtlas, frameSize, offsetInfo);
...
uint16_t TR_Debug::printStackAtlasDetails(uintptr_t startPC, uint8_t *mapBits, int32_t numberOfSlotsMapped,
...
uint8_t *TR_Debug::printMapInfo(uintptr_t startPC, uint8_t *mapBits, int32_t numberOfSlotsMapped, bool fourByteOffsets,
...
void TR_Debug::printStackMapInfo(uint8_t *&mapBits, int32_t numberOfSlotsMapped, int32_t *sizeOfStackAtlas,
...
void TR_Debug::printByteCodeStack(int32_t parentStackIndex, uint16_t byteCodeIndex, size_t *indentLen)
{
