...
void TR_MHJ2IThunkTable::Node::dumpTo(TR_FrontEnd *fe, TR::FILE *file, TR_PersistentArray<Node> &nodeArray, int indent)
{
...
void TR_MHJ2IThunkTable::dumpTo(TR_FrontEnd *fe, TR::FILE *file)
{
    OMR::CriticalSection criticalSection(_monitor);
