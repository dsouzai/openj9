...
public:
    ...
    virtual TR_OpaqueClassBlock *getObjectClassFromKnownObjectIndex(TR::Compilation *comp,
        TR::KnownObjectTable::Index idx, bool *isJavaLangClass) override;
    virtual uintptr_t getStaticReferenceFieldAtAddress(uintptr_t fieldAddress) override;

    virtual ObjectClassInfo getObjectClassInfoFromObjectReferenceLocation(TR::Compilation *comp,
        uintptr_t objectReferenceLocation) override;
    ...
    virtual TR::SymbolReference *refineInvokeCacheElementSymRefWithKnownObjectIndex(TR::Compilation *comp,
        TR::SymbolReference *originalSymRef, uintptr_t *invokeCacheArray) override;
