...
private:
   ...
   uint8_t *alignSegmentOnPageBoundary(const J9MemorySegment &segment, size_t &size);
   ...
   std::map<size_t, Block *> _variableSizedBlockMap; // Maps a block size to a chained list of freed blocks of that size
   }; // class PersistentAllocator
} // namespace J9
