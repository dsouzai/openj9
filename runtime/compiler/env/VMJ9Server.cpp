...
TR_J9VMBase::ObjectClassInfo TR_J9ServerVM::getObjectClassInfoFromObjectReferenceLocation(TR::Compilation *comp,
    uintptr_t objectReferenceLocation)
{
    JITServer::ServerStream *stream = _compInfoPT->getMethodBeingCompiled()->_stream;
    stream->write(JITServer::MessageType::VM_getObjectClassInfoFromObjectReferenceLocation, objectReferenceLocation);
...
TR_OpaqueMethodBlock *TR_J9ServerVM::getMethodFromName(const char *className, const char *methodName,
...
TR::SymbolReference *TR_J9ServerVM::refineInvokeCacheElementSymRefWithKnownObjectIndex(TR::Compilation *comp,
    TR::SymbolReference *originalSymRef, uintptr_t *invokeCacheArray)
{
    ...
    JITServer::ServerStream *stream = _compInfoPT->getMethodBeingCompiled()->_stream;
    stream->write(JITServer::MessageType::VM_refineInvokeCacheElementSymRefWithKnownObjectIndex, invokeCacheArray);
    auto recv = stream->read<TR::KnownObjectTable::Index, uintptr_t *>();
    TR::KnownObjectTable::Index idx = std::get<0>(recv);
    knot->updateKnownObjectTableAtServer(idx, std::get<1>(recv));
...
TR_OpaqueMethodBlock *TR_J9SharedCacheServerVM::getMethodFromName(const char *className, const char *methodName,
    const char *signature)
{
