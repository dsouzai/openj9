...
#define x(a, b, c) a, sizeof(b) - 1, b, (int16_t)strlen(c), c
    ...
    static X StringLatin1Methods[] = { { x(TR::java_lang_StringLatin1_indexOf, "indexOf", "([BI[BII)I") },
        { x(TR::java_lang_StringLatin1_indexOfChar, "indexOfChar", "([BIII)I") },
        { x(TR::java_lang_StringLatin1_inflate_BICII, "inflate", "([BI[CII)V") },
        { x(TR::java_lang_StringLatin1_inflate_BIBII, "inflate", "([BI[BII)V") }, { TR::unknownMethod } };
    ...
    static X StringUTF16Methods[] = { { x(TR::java_lang_StringUTF16_charAt, "charAt", "([BI)C") },
        ...
        { x(TR::java_lang_StringUTF16_getChars_Long, "getChars", "(JI[B)I") }, { TR::unknownMethod } };
    ...
    static X ValueClassMethods[] = { { x(TR::jdk_internal_value_ValueClass_newArrayInstance, "newArrayInstance",
                                         "(Ljdk/internal/value/CheckedType;I)[Ljava/lang/Object;") },
        { x(TR::jdk_internal_value_ValueClass_newNullRestrictedArray, "newNullRestrictedArray",
            "(Ljava/lang/Class;I)[Ljava/lang/Object;") },
        { TR::unknownMethod } };

    static X NullRestrictedCheckedTypeMethods[]
        = { { x(TR::jdk_internal_value_NullRestrictedCheckedType_of, "of",
                "(Ljava/lang/Class;)Ljdk/internal/value/NullRestrictedCheckedType;") },
              { TR::unknownMethod } };
    ...
    bool *unresolvedInCP, bool *isInvokeCacheAppendixNull)
{
    ...
    if (!isUnresolvedEntry) {
        ...
        TR_OpaqueMethodBlock *dummyInvoke = _fe->getMethodFromName("java/lang/invoke/MethodHandle", "linkToStatic",
            "([Ljava/lang/Object;)Ljava/lang/Object;");
        int32_t signatureLength;
