...
TR::SymbolReference *J9::SymbolReferenceTable::findOrCreateDefaultValueSymbolRef(void *defaultValueSlotAddress,
    int32_t cpIndex)
{
    ...
    bool isCondyPrimitive)
{
    ...
    if (owningMethod->isUnresolvedConstantDynamic(cpIndex)) {
        ...
        symRef = findOrCreateCPSymbol(owningMethodSymbol, cpIndex, TR::Address, true, dynamicConst, knownObjectIndex);
    }
    ...
    TR::ResolvedMethodSymbol *owningMethodSymbol, int32_t cpIndex)
{
    ...
    if (owningMethod->isUnresolvedMethodType(cpIndex)) {
        ...
        symRef
            = findOrCreateCPSymbol(owningMethodSymbol, cpIndex, TR::Address, true, methodTypeConst, knownObjectIndex);
    }
    TR::StaticSymbol *sym = (TR::StaticSymbol *)symRef->getSymbol();
    ...
    TR::ResolvedMethodSymbol *owningMethodSymbol, int32_t cpIndex)
{
    ...
    if (owningMethod->isUnresolvedMethodHandle(cpIndex)) {
        ...
        symRef
            = findOrCreateCPSymbol(owningMethodSymbol, cpIndex, TR::Address, true, methodHandleConst, knownObjectIndex);
    }
    TR::StaticSymbol *sym = (TR::StaticSymbol *)symRef->getSymbol();
    ...
    int32_t cpIndex, bool isStore)
{
    ...
    symRef = new (trHeapMemory()) TR::SymbolReference(self(), sym, owningMethodSymbol->getResolvedMethodIndex(),
        cpIndex, unresolvedIndex, TR::KnownObjectTable::UNKNOWN);
