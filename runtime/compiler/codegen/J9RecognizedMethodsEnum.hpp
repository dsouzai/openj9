...
FirstJ9Method = LastOMRMethod + 1,
    ...
    java_lang_String_getChars_charArray, java_lang_String_getChars_byteArray,
    ...
    java_lang_StringUTF16_indexOf, java_lang_StringUTF16_indexOfCharUnsafe, java_lang_StringUTF16_indexOfUnsafe,
    java_lang_StringUTF16_length, java_lang_StringUTF16_newBytesFor, java_lang_StringUTF16_putChar,
    java_lang_StringUTF16_toBytes, java_lang_StringUTF16_getChars_Integer, java_lang_StringUTF16_getChars_Long,
    ...
    java_lang_reflect_Array_getLength, jdk_internal_value_ValueClass_newArrayInstance,
    jdk_internal_value_ValueClass_newNullRestrictedArray, jdk_internal_value_NullRestrictedCheckedType_of,
    java_lang_reflect_Method_invoke, java_util_Arrays_fill, java_util_Arrays_equals, java_lang_String_equals,
