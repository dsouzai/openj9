...
FirstJ9Method = LastOMRMethod + 1,
    ...
    java_lang_String_init_int_int_char_boolean, java_lang_String_init_StringBuilder,
    ...
    java_lang_String_indexOf_char, java_lang_String_indexOf_native, java_lang_String_indexOf_fast,
    java_lang_String_isCompressed, java_lang_String_replace, java_lang_String_compareTo, java_lang_String_hashCode,
    ...
    java_lang_String_regionMatchesInternal, java_lang_String_equalsIgnoreCase, java_lang_String_encodeASCII,
    java_lang_String_compareToIgnoreCase, java_lang_String_unsafeCharAt, java_lang_String_split_str_int,
    java_lang_String_getBytes, java_lang_String_getBytes_subString, java_lang_String_getChars_charArray,
    java_lang_String_getChars_byteArray,

    java_lang_String_checkIndex, java_lang_String_coder, java_lang_String_decodeUTF8_UTF16, java_lang_String_isLatin1,
    java_lang_String_startsWith,

    java_lang_String_valueOf_C, java_lang_String_subString, java_lang_String_deduplicateStrings,

    java_lang_StringLatin1_indexOf, java_lang_StringLatin1_indexOfChar, java_lang_StringLatin1_inflate_BICII,
    java_lang_StringLatin1_inflate_BIBII, java_lang_StringLatin1_newString, java_lang_StringLatin1_replace_char,
    java_lang_StringLatin1_replace_CharSequence, java_lang_StringLatin1_toLowerCase, java_lang_StringLatin1_toUpperCase,
    ...
    java_lang_AbstractStringBuilder_append_String, java_lang_AbstractStringBuilder_ensureCapacityInternal,
    ...
    java_lang_reflect_Array_getLength, java_lang_reflect_Method_invoke, java_util_Arrays_fill, java_util_Arrays_equals,
    java_lang_String_equals, sun_io_ByteToCharSingleByte_convert, sun_io_CharToByteSingleByte_convert,
    sun_io_ByteToCharDBCS_EBCDIC_convert, sun_io_ByteToCharSingleByte_JITintrinsicConvert,
    sun_nio_cs_ISO_8859_1_Encoder_encodeArrayLoop, sun_nio_cs_ISO_8859_1_Encoder_encodeISOArray,
    sun_nio_cs_ISO_8859_1_Decoder_decodeISO8859_1, sun_nio_cs_US_ASCII_Encoder_encodeASCII,
    sun_nio_cs_US_ASCII_Decoder_decodeASCII, sun_nio_cs_ext_SBCS_Encoder_encodeSBCS,
    sun_nio_cs_ext_SBCS_Decoder_decodeSBCS, sun_nio_cs_UTF_8_Decoder_decodeUTF_8, sun_nio_cs_UTF_8_Encoder_encodeUTF_8,
