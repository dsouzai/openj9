...
static bool handleServerMessage(JITServer::ClientStream *client, TR_J9VM *fe, JITServer::MessageType &response)
{
    ...
    switch (response) {
        ...
        case MessageType::VM_getObjectClassInfoFromObjectReferenceLocation: {
            ...
            client->write(response, ci, knot->getPointerLocation(ci.knownObjectIndex));
        } break;
        ...
        case MessageType::VM_refineInvokeCacheElementSymRefWithKnownObjectIndex: {
            ...
            uintptr_t arrayElementRef
                = (uintptr_t)fe->getReferenceElement(*invokeCacheArray, JSR292_invokeCacheArrayAppendixIndex);
    ...
    J9Method *method, TR::IlGeneratorMethodDetails &details, TR::CompilationInfoPerThreadBase *compInfoPT)
{
    ...
    // sequencing monitor critical section scope
    {
        ...
        size_t numPermanentLoadersSent = loaderTable->numPermanentLoadersSentToServer(compInfo);
        ...
        if (numPermanentLoadersSent < permanentLoaders.size()) {
            ...
            newPermanentLoaders.insert(newPermanentLoaders.end(), permanentLoaders.begin() + numPermanentLoadersSent,
    ...
    try {
        ...
        client->buildCompileRequest(persistentInfo->getClientUID(), seqNo, lastCriticalSeqNo, method, clazz,
            *entry->_optimizationPlan, detailsStr, details.getType(), unloadedClasses, illegalModificationList,
            ...
            newKnownIds, newPermanentLoaders);
