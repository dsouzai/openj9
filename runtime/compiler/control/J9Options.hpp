...
enum CompilationOptions
   {
   OMR_OWM                                              = 0x00000000FFFFFFFFULL,
   // Option word mask - these bits identify which option word the option is
   // in (words 0-31 << 32)
   //
   J9_OWM                                               = 0x0000001F00000000ULL,

   // Option word 0
   //
   HWProfilerDisableAOT                                 = 0x0000002000000000ULL,
   HWProfilerDisableRIOverPrivateLinkage                = 0x0000004000000000ULL,
   // Available                                         = 0x0000008000000000ULL,
   // Available                                         = 0x0000010000000000ULL,
   // Available                                         = 0x0000020000000000ULL,
   // Available                                         = 0x0000040000000000ULL,
   // Available                                         = 0x0000080000000000ULL,
   // Available                                         = 0x0000100000000000ULL,
   // Available                                         = 0x0000200000000000ULL,
   // Available                                         = 0x0000400000000000ULL,
   // Available                                         = 0x0000800000000000ULL,
   // Available                                         = 0x0001000000000000ULL,
   // Available                                         = 0x0002000000000000ULL,
   // Available                                         = 0x0004000000000000ULL,
   // Available                                         = 0x0008000000000000ULL,
   // Available                                         = 0x0010000000000000ULL,
   // Available                                         = 0x0020000000000000ULL,
   // Available                                         = 0x0040000000000000ULL,
   // Available                                         = 0x0080000000000000ULL,
   // Available                                         = 0x0100000000000000ULL,
   // Available                                         = 0x0200000000000000ULL,
   // Available                                         = 0x0400000000000000ULL,
   // Available                                         = 0x0800000000000000ULL,
   ...
   // Available                                         = 0x0000020000000000ULL + (1ULL<<32),
   // Available                                         = 0x0000040000000000ULL + (1ULL<<32),
   // Available                                         = 0x0000080000000000ULL + (1ULL<<32),
   // Available                                         = 0x0000100000000000ULL + (1ULL<<32),
   // Available                                         = 0x0000200000000000ULL + (1ULL<<32),
   // Available                                         = 0x0000400000000000ULL + (1ULL<<32),
   // Available                                         = 0x0000800000000000ULL + (1ULL<<32),
   // Available                                         = 0x0001000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0002000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0004000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0008000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0010000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0020000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0040000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0080000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0100000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0200000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0400000000000000ULL + (1ULL<<32),
   // Available                                         = 0x0800000000000000ULL + (1ULL<<32),
   // Available                                         = 0x1000000000000000ULL + (1ULL<<32),
   // Available                                         = 0x2000000000000000ULL + (1ULL<<32),
   // Available                                         = 0x4000000000000000ULL + (1ULL<<32),
   // Available                                         = 0x8000000000000000ULL + (1ULL<<32),
   };
...
class OMR_EXTENSIBLE Options : public OMR::OptionsConnector
   ...
   bool getAnyOption(uint64_t mask)
      ...
      if (mask & OMR_OWM)
         ...
         {
         return (_j9options[(mask & J9_OWM) >> 32] & ((mask & ~J9_OWM) >> 32)) != 0;
         }
      }
   ...
   bool getAllOptions(uint64_t mask)
      ...
      if (mask & OMR_OWM)
         ...
         {
         return (_j9options[(mask & J9_OWM) >> 32] & ((mask & ~J9_OWM) >> 32)) == mask;
         }
      }
   ...
   void setOption(uint64_t mask, bool b = true)
      ...
      if (mask & OMR_OWM)
         ...
         {
         if (b)
            _j9options[(mask & J9_OWM) >> 32] |= ((mask & ~J9_OWM) >> 32);
         else
            _j9options[(mask & J9_OWM) >> 32] &= (~(mask & ~J9_OWM) >> 32);
         }
      }
   ...
   uint32_t                    _j9options[(J9_OWM >> 32) + 1];
