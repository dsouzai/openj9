...
int32_t J9::Options::_retryAOTLoadMaxInvocationCount = -1;
...
TR::OptionTable OMR::Options::_feOptions[] = {
   ...
   {"retryAOTLoadInitialInvocationCount=", "M<nnn>\tInvocation count for an AOT load that will be retried",
           TR::Options::setStaticNumeric, (intptr_t)&TR::Options::_retryAOTLoadInitialInvocationCount, 0, "F%d", NOT_IN_SUBSET},
   {"retryAOTLoadMaxInvocationCount=", "M<nnn>\tMax Invocation count for an AOT load that will be retried",
           TR::Options::setStaticNumeric, (intptr_t)&TR::Options::_retryAOTLoadMaxInvocationCount, 0, "F%d", NOT_IN_SUBSET},
