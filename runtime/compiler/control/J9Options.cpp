...
#define SET_OPTION_BIT(x)   TR::Options::setBit,   offsetof(J9::Options,_j9options[((x)&J9::J9_OWM)>>32]), (static_cast<uintptr_t>(((x)&~J9::J9_OWM)>>32))
#define RESET_OPTION_BIT(x) TR::Options::resetBit, offsetof(J9::Options,_j9options[((x)&J9::J9_OWM)>>32]), (static_cast<uintptr_t>(((x)&~J9::J9_OWM)>>32))
...
TR::OptionTable OMR::Options::_feOptions[] = {
   ...
   {"HWProfilerDisableAOT",           "O<nnn>\tDisable RI AOT",
        SET_OPTION_BIT(J9::HWProfilerDisableAOT), "F", NOT_IN_SUBSET},
   {"HWProfilerDisableRIOverPrivageLinkage","O<nnn>\tDisable RI over private linkage",
        SET_OPTION_BIT(J9::HWProfilerDisableRIOverPrivateLinkage), "F", NOT_IN_SUBSET},
